...
export const CONTRACT_SIGNATURE_LAYOUTS = Object.freeze({
  ...
  bom_familia_portabilidade: [
    placement(15, 105, 203, 82, 17),
    placement(17, 121, 268, 76, 9),
    placement(18, 121, 244, 76, 18),
    placement(19, 121, 247, 76, 18),
    placement(20, 121, 235, 76, 18),
  ],
  essencial: [
  ...
  topazio: [
    placement(10, 121, 228, 76, 18),
    placement(11, 121, 223, 76, 18),
  ...
  combo_multi_selecao: [
    ...
    placement(17, 116, 250, 74, 12),
    placement(18, 112, 248, 82, 16),
    placement(19, 112, 243, 82, 16),
  ],
  convalescenca: [placement(1, 116, 244, 70, 12)],
});
