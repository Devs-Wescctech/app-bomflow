...
foreach($json as $json){
	...
	if($produto_id=='52247119'){$quant_km='1000'; $extenso='Um Mil';}
	if($produto_id=='114011118'){$quant_km='2000'; $extenso='Dois Mil';}
	if($produto_id=='203567296'){$quant_km='500'; $extenso='Quinhentos';}
	if($produto_id=='203567310'){$quant_km='1000'; $extenso='Um Mil';}
	if($produto_id=='203567429'){$quant_km='2000'; $extenso='Dois Mil';}
	if($produto_id=='203567456'){$quant_km='3000'; $extenso='Tres Mil';}
	/*
	echo "
	total: $total<br>
	pedido: $pedido<br>
