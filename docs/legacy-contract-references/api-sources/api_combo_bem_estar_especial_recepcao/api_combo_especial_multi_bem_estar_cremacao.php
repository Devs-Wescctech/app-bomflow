...
**************************************************/
$total = '0';//quantidade
$total_valor_cremacao = '0';

$curl = curl_init();
curl_setopt_array($curl, array(
  CURLOPT_URL => "http://erp.wescctech.com.br:8080/BOMPASTOR/api/API_COMBO_ESPECIAL_MULTI_CREMACAO?documento=$cpf&pedido=$pedido",
...
foreach($json as $json){
	...
	$total_valor_cremacao = $json["total_valor"];
	/*
	echo "
	total: $total<br>
	pedido: $pedido<br>
