...
curl_setopt_array($curl, array(
  CURLOPT_URL => "http://erp.wescctech.com.br:8080/BP_MULTI/api/API_PESQUISA_ASSINATURA_BOMCORP?documento=$cnpj&contrato=$contrato",
...
foreach($json as $json){
	...
	$titular_nome = $json["contratante"];
	$data_emissao = @$json["data_aprovacao"];
/*	echo "
