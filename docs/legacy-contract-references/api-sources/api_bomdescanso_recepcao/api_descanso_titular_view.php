...
echo "Entrou API_TOTAL_MAIS_TITULAR_BOM_FARMA?documento=$cpf<br><br>";
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "http://erp.wescctech.com.br:8080/BP_MULTI/api/API_TOTAL_MAIS_TITULAR_BOM_FARMA?documento=$cpf",
...
echo "<strong>response api_descanso_titular_view:</strong><br>";
echo $response;
echo "<br><br>";
