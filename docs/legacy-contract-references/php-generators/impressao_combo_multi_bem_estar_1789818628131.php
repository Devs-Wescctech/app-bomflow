...
if (@$_GET["gfFffsAuLJgYrdtHGFfgFjJHfkGhKhuGDRei"]<>'' and @$_GET["skdfeioHHHksdjskJJ"]<>''){
	...
	include("api_combo_multi_bem_estar_recepcao/api_combo_multi_bem_estar_pesquisa_titular.php");
	include("api_combo_multi_bem_estar_recepcao/api_combo_multi_bem_estar_titular.php");
	include("api_combo_multi_bem_estar_recepcao/api_dados_cob_combo_multi_bem_estar.php");
	include("api_combo_multi_bem_estar_recepcao/api_combo_bom_pet_dependentes.php");
	include("api_combo_multi_bem_estar_recepcao/api_combo_bom_med_dependentes.php");
	include("api_combo_multi_bem_estar_recepcao/api_combo_bom_auto_dados_carros.php");
	...
	****************************************************************/
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/combo_multi_bem_estar/contrato_01.jpg';//cria nome da imagem de cabecalho
...
//*******DATA **********
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/combo_multi_bem_estar/contrato_02.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/combo_multi_bem_estar/contrato_03.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/combo_multi_bem_estar/contrato_04.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/combo_multi_bem_estar/contrato_05.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/combo_multi_bem_estar/contrato_06.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/combo_multi_bem_estar/contrato_07.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/combo_multi_bem_estar/contrato_08.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
...
//*******DATA **********
	...
	$pdf->Output('combo_multi_bem_estar'.$pedido.'.pdf', "I");
}else{
	exit;
}
