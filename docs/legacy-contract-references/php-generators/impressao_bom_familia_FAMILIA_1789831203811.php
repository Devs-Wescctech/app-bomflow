...
if (@$_GET["gfFffsAuLJgYrdtHGFfgFjJHfkGhKhuGDRei"]<>'' and @$_GET["skdfeioHHHksdjskJJ"]<>''){
	...
	include("api_bomfamilia_recepcao/api_familia_pesquisa_titular.php");
	include("api_bomfamilia_recepcao/api_familia_titular.php");
	include("api_bomfamilia_recepcao/api_familia_dependentes.php");
	include("api_bomfamilia_recepcao/api_dados_cob_familia.php");
	include("api_bomfamilia_recepcao/api_familia_cremacao.php");
	include("api_bomfamilia_recepcao/api_familia_coroa.php");
	include("api_bomfamilia_recepcao/api_familia_quilometragem.php");
	...
	****************************************************************/
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/bom_familia/01.jpg';//cria nome da imagem de cabecalho
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/bom_familia/02.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/bom_familia/03.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/bom_familia/04.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/bom_familia/05.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
...
///*******************VENCIMENTO
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/bom_familia/06.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/bom_familia/07.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/bom_familia/08.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/bom_familia/09.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/bom_familia/10.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/bom_familia/11.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/bom_familia/12.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/bom_familia/13.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/bom_familia/14.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/bom_familia/15.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/bom_familia/16.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/bom_familia/17.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	if ($total_valor_coroa>0){
		...
		$x = 0;
		$y = 0;
		$logo = 'contratos/bom_familia/01_coroa.jpg';//cria nome da imagem de cabecalho
		$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	if ($total_valor_cremacao>0){
		...
		$x = 0;
		$y = 0;
		$logo = 'contratos/bom_familia/01_cremacao.jpg';//cria nome da imagem de cabecalho
		$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
		...
		$x = 0;
		$y = 0;
		$logo = 'contratos/bom_familia/02_cremacao.jpg';//cria nome da imagem de cabecalho
		$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
		...
		$pdf->SetFont('times', '', 11);
		$pdf->SetXY($x, $y);
		$pdf->Cell(118, $altura, utf8_decode($total_valor_cremacao), 0);//contorno
		
		$valor_extenso_cremacao = func_escreve_numero_extenso($total_valor_cremacao, 0, 0);
		$valor_extenso_cremacao=$valor_extenso_cremacao.' Reais';
		$x = 23;
		$y = 53;
		//Cliente
		$pdf->SetFont('times', '', 11);
		$pdf->SetXY($x, $y);
		$pdf->Cell(118, $altura, utf8_decode($valor_extenso_cremacao), 0);//contorno
	...
	$pdf->Output('bom_familia'.$pedido.'.pdf', "I");
}else{
	exit;
}
?>