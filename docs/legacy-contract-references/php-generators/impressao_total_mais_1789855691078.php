...
if (@$_GET["gfFffsAuLJgYrdtHGFfgFjJHfkGhKhuGDRei"]<>'' and @$_GET["skdfeioHHHksdjskJJ"]<>''){
	...
	include("api_total_mais_recepcao/api_total_mais_pesquisa_titular.php");
	include("api_total_mais_recepcao/api_total_mais_titular.php");
	include("api_total_mais_recepcao/api_total_mais_dependentes.php");
	include("api_total_mais_recepcao/api_dados_cob_total_mais.php");
	include("api_total_mais_recepcao/api_total_mais_cremacao.php");
	include("api_total_mais_recepcao/api_total_mais_quilometragem.php");		
	...
	****************************************************************/
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/plano_total_mais/01.jpg';//cria nome da imagem de cabecalho
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/plano_total_mais/02.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/plano_total_mais/03.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/plano_total_mais/04.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/plano_total_mais/05.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
...
///*******************VENCIMENTO
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/plano_total_mais/06.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/plano_total_mais/07.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/plano_total_mais/08.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/plano_total_mais/09.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/plano_total_mais/10.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/plano_total_mais/11.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/plano_total_mais/12.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
...
/*	////PÁGINA 9 ####################
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/plano_total_mais/13.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
*/	
	...
	if (count($bom_med)>0){
		...
		$x = 0;
		$y = 0;
		$logo = 'contratos/plano_total_mais/14.jpg';//cria nome da imagem de cabecalho
		$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$pdf->Cell(2, $altura, $postal8, 0);//contorno
		...
		if($dependentes_tem==1){
			...
			for($i=0; $i<count($dependentes_bm); $i++){
				$dados_dependentes = $dependentes_bm[$i];
	...
	if ($plano_pagamento==46285 or $plano_pagamento==47214448 or $plano_pagamento==48395023 or $plano_pagamento==88733784){
		...
		$x = 0;
		$y = 0;
		$logo = 'contratos/plano_total_mais/15.jpg';//cria nome da imagem de cabecalho
		$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
		...
		$x = 0;
		$y = 0;
		$logo = 'contratos/plano_total_mais/16.jpg';//cria nome da imagem de cabecalho
		$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
		...
		$x = 0;
		$y = 0;
		$logo = 'contratos/plano_total_mais/17.jpg';//cria nome da imagem de cabecalho
		$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
...
if($total_valor_quilometragem>0){	
		...
		$pdf->SetFont('times', '', 10);
		$pdf->SetXY($x, $y);
		$pdf->Cell(75, $altura, $extenso, 0);//contorno
