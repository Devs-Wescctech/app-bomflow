...
if (@$_GET["gfFffsAuLJgYrdtHGFfgFjJHfkGhKhuGDRei"]<>'' and @$_GET["skdfeioHHHksdjskJJ"]<>''){
	...
	include("api_combo_selecao_recepcao/api_combo_selecao_multi_bem_estar_pesquisa_titular.php");
	include("api_combo_selecao_recepcao/api_combo_selecao_multi_bem_estar_titular.php");
	include("api_combo_selecao_recepcao/api_combo_selecao_multi_bem_estar_cob.php");
	include("api_combo_selecao_recepcao/api_combo_selecao_bom_pet_dependentes.php");
	include("api_combo_selecao_recepcao/api_combo_selecao_bom_med_dependentes.php");
	include("api_combo_selecao_recepcao/api_combo_selecao_bom_auto_dados_carros.php");
	include("api_combo_selecao_recepcao/api_combo_selecao_multi_bem_estar_coroa.php");
	include("api_combo_selecao_recepcao/api_combo_selecao_multi_bem_estar_cremacao.php");	
	include("api_combo_selecao_recepcao/api_combo_selecao_multi_bem_estar_quilometragem.php");	
	include("api_combo_selecao_recepcao/api_combo_selecao_multi_bem_estar_tanatopraxia.php");
	...
	****************************************************************/
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/combo_selecao/contrato_01.jpg';//cria nome da imagem de cabecalho
	...
	*/
	...
	$mensalidade_total=0;
	$mensalidade_total = $total_valor + $total_dep;
...
//*******DATA **********
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/combo_selecao/contrato_02.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/combo_selecao/contrato_03.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/combo_selecao/contrato_04.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/combo_selecao/contrato_05.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/combo_selecao/contrato_06.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/combo_selecao/contrato_07.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$x = 0;
	$y = 0;
	$logo = 'contratos/combo_selecao/contrato_08.jpg';//cria nome da imagem de cabecalho
	$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
...
//*******DATA **********
	...
	if($total_valor_cremacao>0){	
		...
		$x = 0;
		$y = 0;
		$logo = 'contratos/combo_selecao/cremacao.jpg';//cria nome da imagem de cabecalho
		$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	if($total_valor_tanotapraxia>0){	
		...
		$x = 0;
		$y = 0;
		$logo = 'contratos/combo_selecao/tanatopraxia.jpg';//cria nome da imagem de cabecalho
		$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	if($total_valor_quilometragem>0){	
		...
		$x = 0;
		$y = 0;
		$logo = 'contratos/combo_selecao/quilometragem.jpg';//cria nome da imagem de cabecalho
		$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	if ($total_valor_coroa>0){
		...
		$x = 0;
		$y = 0;
		$logo = 'contratos/combo_selecao/01_coroa.jpg';//cria nome da imagem de cabecalho
		$pdf->Image($logo, $x, $y, 210, 297, "JPEG");
	...
	$pdf->Output('combo_selecao'.$pedido.'.pdf', "I");
}else{
	exit;
}
