    ...
    try {
      const payload = {
        ...
        pessoas: editor.pessoas.map(({ client_key, ...person }) => {
          const cleaned = { ...person, telefone: normalizePhone(person.telefone) };
