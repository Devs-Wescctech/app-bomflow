  ...
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        description:
          "Atualiza o status (whitelist Pendente/Solucionado/Cancelado). Solucionado exige ao menos 1 imagem anexada (comprovante de remoção). marcar_pet_falecido=true só é aceito ao Solucionar e registra o falecimento apenas localmente (sem escrita no ERP).",
        auth: true,
        params: [{ name: "id", type: "string", required: true, description: "ID do atendimento" }],
        body: [
          ...
          { name: "marcar_pet_falecido", type: "boolean", required: false, description: "Marca o pet como Falecido (status local)" },
        ],
        response: { status: 200, example: { id: 1, status_atendimento: "Solucionado" } },
      },
      {
        id: "bp-imagens",
        method: "POST",
