          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-purple-700 dark:text-purple-300">R$ {totalGeralReceita.toLocaleString('pt-BR', { minimumFractionDigits: 0 })}</p>
                <p className="text-xs text-purple-600 dark:text-purple-400 mt-1">Ticket médio: R$ {totalGeralVendas > 0 ? (totalGeralReceita / totalGeralVendas).toFixed(0) : 0}</p>
              </div>
                      ...
                      <div className="flex flex-col items-center">
                        ...
                        <div className="grid grid-cols-2 gap-2 w-full mt-3">
                          ...
                          <div className="bg-orange-100 dark:bg-orange-950 p-2 rounded">
                            ...
                            <p className="text-sm font-bold text-orange-600 dark:text-orange-400">R$ {stat.receita.toFixed(0)}</p>
                          </div>
                        </div>
                      </div>
                    </CardContent>
