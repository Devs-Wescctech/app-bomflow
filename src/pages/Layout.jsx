...
const menuModules = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Dashboard", url: createPageUrl("PreSalesDashboard"), icon: LayoutDashboard, auditReport: true, requiredSubmenu: "PreSalesDashboard", requiresExplicitSubmenu: true },
    ]
  },
  {
    id: "postsales",
    ...
    items: [
      ...
      { title: "Dashboard", url: createPageUrl("PosVendasDashboard"), icon: LayoutDashboard, postsalesDashboard: true, requiredSubmenu: "PosVendasDashboard", requiresExplicitSubmenu: true },
      { title: "Monitor Pós-Vendas", url: createPageUrl("PosVendasMonitor"), icon: Activity, postSales: true },
      { title: "Congelados Pós-Vendas", url: createPageUrl("PosVendasCongelados"), icon: ShieldAlert, auditReport: true },
    ]
  },
  {
    id: "sales",
    ...
    items: [
      ...
      { title: "Redistribuição de leads", url: `${createPageUrl("LeadRedistribution")}?module=sales`, icon: Users, supervisorOnly: true, requiredSubmenu: "LeadRedistributionSales", requiresExplicitSubmenu: true },
      ...
      { title: "Devoluções Pós-Vendas", url: createPageUrl("PosVendasDevolucoes"), icon: ClipboardCheck, supervisorOnly: true },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Redistribuição de leads", url: `${createPageUrl("LeadRedistribution")}?module=sales_pj`, icon: Users, supervisorOnly: true, requiredSubmenu: "LeadRedistributionSalesPJ", requiresExplicitSubmenu: true },
      { title: "Agenda", url: createPageUrl("SalesAgenda"), icon: CalendarIcon },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Redistribuição de leads", url: `${createPageUrl("LeadRedistribution")}?module=sales_upsell`, icon: Users, supervisorOnly: true, requiredSubmenu: "LeadRedistributionUpsell", requiresExplicitSubmenu: true },
      { title: "Agenda", url: createPageUrl("SalesUpsellAgenda"), icon: CalendarIcon },
      ...
      { title: "Templates", url: createPageUrl("ProposalTemplates"), icon: FileText, supervisorOnly: true },
      { title: "Novo Orçamento", url: createPageUrl("UpsellNovoOrcamento"), icon: ClipboardList, allowedEmails: ['teste3@bomflow.com', 'bomflow4@wescctech.com.br'] },
      { title: "Orçamento ERP (Legacy)", url: createPageUrl("ErpOrcamentoForm"), icon: ClipboardList, allowedEmails: ['teste3@bomflow.com'] },
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Redistribuição de leads", url: `${createPageUrl("LeadRedistribution")}?module=referral`, icon: Users, supervisorOnly: true, requiredSubmenu: "LeadRedistributionReferral", requiresExplicitSubmenu: true },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Relatório de Utilizações", url: createPageUrl("BomPetRelatorio"), icon: FileBarChart, postSalesReport: true },
      {
        ...
        icon: Building2,
        requiredSubmenu: "BomPetParceiros",
