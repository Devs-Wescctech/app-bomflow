...
function SortableLeadCard({ lead, stage, pendingTasksCount, agentData, navigate, formatCurrency, formatDate, updateLeadMutation, TasksPopover, onStageChange, allStages }) {
  const {
    attributes,
    listeners,
    setNodeRef,
