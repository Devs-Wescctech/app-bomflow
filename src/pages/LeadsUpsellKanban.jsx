...
export default function LeadsUpsellKanban() {
  ...
  const updateLeadMutation = useMutation({
    mutationFn: ({ id, data }) => upsell.entities.LeadUpsell.update(id, data),
  ...
  const completeTaskMutation = useMutation({
    mutationFn: ({ taskId }) => upsell.entities.ActivityUpsell.update(taskId, {
      completed: true,
  ...
  const deleteTaskMutation = useMutation({
    mutationFn: ({ taskId }) => upsell.entities.ActivityUpsell.delete(taskId),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['allActivities'] });
      ...
      <div className="space-y-4 md:space-y-6">
        ...
        >
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Link to={createPageUrl('NewLeadUpsell')} className="flex-1 sm:flex-none">
