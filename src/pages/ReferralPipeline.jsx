...
const STAGES = [
  ...
  { id: 'qualificado', label: 'Fechado', color: 'from-indigo-500 to-indigo-600', lightBg: 'bg-indigo-50 dark:bg-indigo-950/30', gradient: 'from-indigo-500 to-indigo-600', borderColor: 'border-indigo-500', shadowColor: 'shadow-indigo-200/50 dark:shadow-indigo-900/30', textColor: 'text-indigo-500 dark:text-indigo-400' },
        ...
        <div className="relative bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0 pt-0.5">
              ...
              {(() => {
                const d = safeDate(referral.created_at || referral.createdAt);
                return d ? (
                  <div className="flex items-center gap-1.5 mt-1">
      ...
      <div className="space-y-6">
        ...
        {viewMode === 'kanban' && (
          <>
            ...
            <div 
              ref={headersRef}
              className="overflow-x-auto pb-0 cursor-grab select-none"
