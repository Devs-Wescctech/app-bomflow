...
export const REFERRAL_STAGES = [
  ...
  { id: 'validacao', label: 'Validação', color: '#8b5cf6', gradient: 'from-violet-500 to-purple-500' },
  { id: 'contato_iniciado', label: 'Contato Iniciado', color: '#06b6d4', gradient: 'from-cyan-500 to-teal-500' },
  { id: 'qualificado', label: 'Qualificado', color: '#3b82f6', gradient: 'from-blue-500 to-indigo-500' },
